...
if ($short_link == 'on') {
$count_short_link = $mysqli->query("SELECT * FROM ip_list_address WHERE claim_address = '$chaddress'")->fetch_object()->count_value;
$total_short_link = $mysqli->query("SELECT * FROM ip_list_address WHERE claim_address = '$chaddress'")->fetch_object()->total_value;
...
<body style="background:<?php echo $bodycolor ?>;">
<?php
...
<div style="background-color:<?php echo $socialc ?>;">
<div class="Social1">
...
</div><div class="header" style="background-color:<?php echo $headerco ?>;">
<ul id="nav">
<li><a href="index.php">Home</a></li>
<li><a href="?op=faucets-list">Faucet List</a></li>
<li><a href="?op=ptc-list">PTC Sites List</a></li>
<li><a href="?op=advertising">Advertising</a></li>
</ul>
</div>
<div class="disbody">
...
?>
<style>
.btctable {border-collapse: collapse;border: 1px solid #000;width: 100%;background-color: <?php echo $flboxc ?>;letter-spacing: 1px;margin:0;}
.btctable1 {border-collapse: collapse;border: 1px solid #000;background-color: <?php echo $ptclcc ?>;width: 100%;color:#000;font-size:12px;margin:0;letter-spacing: 1px;}
.btctable1 td {border: 1px solid #fff;text-align:center;}
.fautable{border-collapse: collapse;border: 1px solid #ddd;width: 100%;background:<?php echo $fltc ?>;}
.fautable th{border: 1px solid #ddd;background:#a88e42;padding:10px;}
.fautable tr:nth-child(even) {background-color: <?php echo $ptclbc ?>;}
.fautable td {padding:4px;border: 1px solid #ddd;}
#triangled {background-color:<?php echo $flhc ?>;padding:15px 10px;font-size:25px;color:#fff;text-shadow: 1px 1px #000;}
</style>
...
<?php
}elseif ($opt == "advertising") {
if(!empty($_POST["again_check"])) {
$adsid = $_POST["adsid"];
$againcode = $_POST["againcode"];
$opian = "Wait : Payment confirmed again.";
$queryadsupdate = "UPDATE pendwebs Set status='Panding', transaction='$againcode', reqapp='', opian='$opian' where tnum='$adsid'";
$resultads = mysqli_query($mysqli, $queryadsupdate);
header('Location: ?op=advertising');
exit;
}
if(!empty($_POST["order_check"])) {
$emailcheck = $_POST['emailcheck'];
$sqlche = "SELECT * FROM pendwebs WHERE usersecode='$emailcheck'";
$resultche = mysqli_query($mysqli, $sqlche);
$totalche = mysqli_num_rows($resultche);
if ($totalche == "0") {
?>
<style>
.abodyd {width:100%;margin-bottom:20px;}
.disbody {padding:5% 10px 5% 10px;}
...
<div class="abodyd">
<div class="formcov">
<div id="triangled" align="center"><h1>You Are not Ads Members</h1></div>
</div>
</div>
</div>
<?php
}else{
$sqlapp = "SELECT * FROM pendwebs WHERE usersecode='$emailcheck' and status='ok'";
$resultapp = mysqli_query($mysqli, $sqlapp);
$totalapp = mysqli_num_rows($resultapp);
$sqlpen = "SELECT * FROM pendwebs WHERE usersecode='$emailcheck' and status='Panding'";
$resultpen = mysqli_query($mysqli, $sqlpen);
$totalpen = mysqli_num_rows($resultpen);
?>
<tr>
<td>
<style>
.abodyd {width:100%;margin-bottom:20px;}
.formcov {overflow:auto;margin:0 auto;width:99%;background:#fff;overflow:auto;border: 1px solid #000;box-shadow: 0 0 8px #6b6b6b;}
#triangled {padding:15px 10px;font-size:100%;color:#fff;}
.forma {padding:5px;}
.distable {border-collapse: collapse;width: 100%;}
.distable tr:nth-child(even) {background-color: #f2f2f2;}
.distable th {background-color: #fff;padding:5px;}
.disttdo {text-align:center;padding:5px;}
.disttd {padding:5px;}
.disbody {padding:5% 10px 5% 10px;}
.disrnot {text-align:center;padding:5px;}
.disttdoc a:link, .disttdoc a:visited {color: #fff;background-color: #0090c7;font-size:12px;padding:5px;margin:3px;text-align: left;text-decoration: none;display: inline-block;letter-spacing: 1px;}
.disttdoc a:hover,.disttdoc a:active {color: #fff;background-color: #00749f;}
.disttdou a:link, .disttdou a:visited {color: #fff;background-color:#0067a7;font-size:12px;padding:5px;margin:3px;text-align: left;text-decoration: none;display: inline-block;letter-spacing: 1px;}
.disttdou a:hover,.disttdou a:active {color: #fff;background-color: #00749f;}
.disttdox a:link, .disttdox a:visited {color: #fff;background-color:#9f1a00;font-size:12px;padding:5px;margin:3px;text-align: left;text-decoration: none;display: inline-block;letter-spacing: 1px;}
.disttdox a:hover,.disttdox a:active {color: #fff;background-color: #721402;}
h1 {font-family: arial, sans-serif;font-size: 16px;font-weight: bold;margin-top: 0px;margin-bottom: 1px;letter-spacing: 1px;}
</style>
<table class="distable" border="1" style="background-color:<?php echo $adsboxc ?>;">
<tbody>
<tr>
<td>
<div class="disbody">
<div class="abodyd">
<div class="formcov">
<div id="triangled" align="center" style="background-color:<?php echo $adsdetailsc ?>;"><h1>Your Ads Details</h1></div>
</div>
</div>
<div class="abodyd">
<div class="formcov">
<div id="triangled" style="background-color:<?php echo $adshc ?>;"><h1>Approval Website</h1></div>
<div class="forma">
<table class="distable" border="1">
<?php
if ($totalapp == "0") {
echo '<tr><td class="disrnot" style="background-color:'.$adsnored.'">No Record Found</td></tr>';
}else{
?>
<tr><th width='180'>Headline</th><th>URL</th><th width='20'>Views</th><th width='20'>Impressions</th><th width='20'>Banner&nbsp;Size</th></tr>
<?php
while($myrowmem = mysqli_fetch_array($resultapp)){
?>
<tr>
<td class="disttd"><?php echo substr($myrowmem["headline"], 0, 20); ?>.....</td>
<td class="disttd"><?php echo $myrowmem["targeturl"]; ?></td>
<td class="disttdo"><?php echo $myrowmem["viewads"]; ?></td>
<td class="disttdo"><?php echo $myrowmem["bimpres"]; ?></td>
<td class="disttdo"><?php echo $myrowmem["bsize"]; ?></td>
</tr>
<?php
}}
?>
...
<div class="abodyd">
<div class="formcov">
<div id="triangled" style="background-color:<?php echo $adshc ?>;"><h1>Pending Website</h1></div>
<div class="forma">
<table class="distable" border="1">
<?php
if ($totalpen == "0") {
...
?>
<tr><th width='180'><h1>Headline</h1></th><th>URL</th><th width='20'>Status</th></tr>
<?php
while($rowdis = mysqli_fetch_array($resultpen)){
?>
<tr>
<td class="disttd"><?php echo substr($rowdis["headline"], 0, 20); ?>.....</td>
<td class="disttd"><?php echo $rowdis["targeturl"]; ?></td>
<td class="disttdo" width="200" style="background:#fc0;">
<b><?php echo $rowdis["opian"]; ?> <br></b>
</td>
<?php
$req = $rowdis["reqapp"];
if ($req == '1') {
?>
<form class="form1" action="?op=advertising" method="post">
<td class="disttdo" width="300" style="background:#fc0;">
<b>Transaction ID u send this:<br>Type the correct Transaction ID:</b>
<textarea rows="1" cols="30" name="againcode"><?php echo $rowdis["transaction"]; ?></textarea>
</td>
<td class="disttdo" width="50" style="background:#fc0;">
<input type="hidden" name="adsid" value="<?php echo $rowdis["tnum"]; ?>">
<input type="submit" name="again_check" value="Request Again">
</td>
</form>
<?php
}
...
<td>
<div class="clearfixa">
<div class="bodyc" style="background-color:#fff">
<table width="85%" border="0" cellspacing="5" cellpadding="5" align="center">
<form class="form1" action="?op=advertising" method="post">
<tr>
<td align="left" width="650">
<font size="6"><b>Banner Impressions Advertising</b></font><br><br>
<font size="5"><b>Banner 468x60.</b></font><br>
<font size="4"><?php echo $myrow468["banrimp1"]; ?> Banner Impressions - Price to BTC - <?php echo $myrow468["banrpric1"]; ?>&nbsp;
<input type="submit" name="order_41" value="Order Form"><br>
<?php echo $myrow468["banrimp2"]; ?> Banner Impressions - Price to BTC - <?php echo $myrow468["banrpric2"]; ?>&nbsp;
<input type="submit" name="order_42" value="Order Form"><br>
<?php echo $myrow468["banrimp3"]; ?> Banner Impressions - Price to BTC - <?php echo $myrow468["banrpric3"]; ?>&nbsp;
<input type="submit" name="order_43" value="Order Form"><br></font>
</td><td>
<div class="ftal"><b>Banner Impressions Order Check:</b></div>
<input type="text" name="emailcheck" value="" placeholder="E-Mail" /><br>
<input type="submit" name="order_check" value="Banner Order">
</td>
</tr>
<tr>
<td align="left" colspan=2>
<font size="5"><b>Banner 728x90.</b></font><br>
<font size="4"><?php echo $myrow728["banrimp1"]; ?> Banner Impressions - Price to BTC - <?php echo $myrow728["banrpric1"]; ?>&nbsp;
<input type="submit" name="order_71" value="Order Form"><br>
<?php echo $myrow728["banrimp2"]; ?> Banner Impressions - Price to BTC - <?php echo $myrow728["banrpric2"]; ?>&nbsp;
<input type="submit" name="order_72" value="Order Form"><br>
<?php echo $myrow728["banrimp3"]; ?> Banner Impressions - Price to BTC - <?php echo $myrow728["banrpric3"]; ?>&nbsp;
<input type="submit" name="order_73" value="Order Form"><br>
</font>
</td>
</tr>
<tr>
<td align="left" colspan=2>
<font size="5"><b>Banner 120x600.</b></font><br>
<font size="4"><?php echo $myrow120["banrimp1"]; ?> Banner Impressions - Price to BTC - <?php echo $myrow120["banrpric1"]; ?>&nbsp;
<input type="submit" name="order_61" value="Order Form"><br>
<?php echo $myrow120["banrimp2"]; ?> Banner Impressions - Price to BTC - <?php echo $myrow120["banrpric2"]; ?>&nbsp;
<input type="submit" name="order_62" value="Order Form"><br>
<?php echo $myrow120["banrimp3"]; ?> Banner Impressions - Price to BTC - <?php echo $myrow120["banrpric3"]; ?>&nbsp;
<input type="submit" name="order_63" value="Order Form"><br></font>
</td>
</tr>
</form>
<tr>
<td align="left" colspan=2>
<div align="left"><font size="4"><b>How it works:</b><br></font>
<ul>
<li><font size="3">Pay for your package the price shown up.</font></li>
...
<li><font size="3">Once your payment has been confirmed, we will process your order immediately.</font></li>
</ul>
</div>
<p>
<font size="6">
<b>Payments may be sent directly through</b>
</font>
<br>
<br>
<font size="4">
<b>- Faucetpay to # kako0000000</b> Help
<br>
<b>- Cryptocoins to # 1LEYrV8rbSe8xtTSex1eoanSz9KgJuLkik</b> Help
<br>
<b>- Payeer to # P63093907</b> Help
<br>
</font>
</p>
<hr align=center>
<?php
if(!empty($_POST["order_41"]) or !empty($_POST["order_42"]) or !empty($_POST["order_43"]) or !empty($_POST["order_71"]) or !empty($_POST["order_72"]) or !empty($_POST["order_73"]) or !empty($_POST["order_61"]) or !empty($_POST["order_62"]) or !empty($_POST["order_63"])) {
?>
<style>
.abody1 {margin:0 auto;}
#textadc1{border:1px solid #000;background-color: #e0d5b1;width:600px;margin:0 auto;box-shadow: 1px 1px 4px 2px #999;}
#triangle1 {font-family: arial, sans-serif;font-weight: bold;text-shadow: 1px 1px #000;background-color:#a88e42;border-bottom:1px solid #635427;padding:4% 4%;font-size:120%;color:#fff;}
#textadc1 input[type="email"],#textadc1 input[type="password"],#textadc1 input[type="text"]{width:95%;background:#fff;margin-bottom:4%;border:1px solid #999;padding:2%;font-family:'Open Sans',sans-serif;font-size:95%;color:#555;}
#textadc1 input[type="submit"]{width:100%;background:#3399cc;border:0;padding:4%;font-family:Verdana, sans-serif;text-shadow: 1px 1px #000;font-size:100%;color:#fff;cursor:pointer;}
#textadc1 input[type="submit"]:hover{background:#2288bb;}
.ftal {font-family: arial, sans-serif;font-size:14px;}
.ftalb {font-family: arial, sans-serif;font-size:14px;padding:2%;}
.abodyf {padding:4% 4% 1% 4%;}
.abodyf1 {padding:4% 4% 2% 4%;}
</style>
<div class="abody1">
<form action="requestwebsit.php" method="post">
<div id="textadc1">
<?php
if(isset($message))
{
...
?>
<div id="triangle1">Account Create of Text Ads</div>
<div class="abodyf">
<div class="ftal"><b>Your Email:</b></div>
<input type="text" name="email" value="" placeholder="E-Mail" />
<div class="ftal"><b>Payment Method</b></div>
<select name="pay_system">
<option value=''>--- Select Payment Type ---</option>
<option value="Faucetpay">Faucetpay</option>
<option value="EGold">Cryptocoins</option>
<option value="Payeer">Payeer</option>
</select>
<div class="ftalb">
<table width="100%">
<tr>
<td><b>Banner Size</b></td>
<td><b>Banner Impressions</b></td>
<td><b>Price to BTC</b></td>
</tr>
<tr>
<?php
if(!empty($_POST["order_41"])) {
?>
<td><b><?php echo $myrow468["banrsize"]; ?></b></td>
<td><b><?php echo $myrow468["banrimp1"]; ?></b></td>
<td><b><?php echo $myrow468["banrpric1"]; ?></b><input type="hidden" name="ordern" value="order_1"></td>
<?php
}elseif(!empty($_POST["order_42"])) {
?>
<td><b><?php echo $myrow468["banrsize"]; ?></b></td>
<td><b><?php echo $myrow468["banrimp2"]; ?></b></td>
<td><b><?php echo $myrow468["banrpric2"]; ?></b><input type="hidden" name="ordern" value="order_2"></td>
<?php
}elseif(!empty($_POST["order_43"])) {
?>
<td><b><?php echo $myrow468["banrsize"]; ?></b></td>
<td><b><?php echo $myrow468["banrimp3"]; ?></b></td>
<td><b><?php echo $myrow468["banrpric3"]; ?></b><input type="hidden" name="ordern" value="order_3"></td>
<?php
}elseif(!empty($_POST["order_71"])) {
?>
<td><b><?php echo $myrow728["banrsize"]; ?></b></td>
<td><b><?php echo $myrow728["banrimp1"]; ?></b></td>
<td><b><?php echo $myrow728["banrpric1"]; ?></b><input type="hidden" name="ordern" value="order_4"></td>
<?php
}elseif(!empty($_POST["order_72"])) {
?>
<td><b><?php echo $myrow728["banrsize"]; ?></b></td>
<td><b><?php echo $myrow728["banrimp2"]; ?></b></td>
<td><b><?php echo $myrow728["banrpric2"]; ?></b><input type="hidden" name="ordern" value="order_5"></td>
<?php
}elseif(!empty($_POST["order_73"])) {
?>
<td><b><?php echo $myrow728["banrsize"]; ?></b></td>
<td><b><?php echo $myrow728["banrimp3"]; ?></b></td>
<td><b><?php echo $myrow728["banrpric3"]; ?></b><input type="hidden" name="ordern" value="order_6"></td>
<?php
}elseif(!empty($_POST["order_61"])) {
?>
<td><b><?php echo $myrow120["banrsize"]; ?></b></td>
<td><b><?php echo $myrow120["banrimp1"]; ?></b></td>
<td><b><?php echo $myrow120["banrpric1"]; ?></b><input type="hidden" name="ordern" value="order_7"></td>
<?php
}elseif(!empty($_POST["order_62"])) {
?>
<td><b><?php echo $myrow120["banrsize"]; ?></b></td>
<td><b><?php echo $myrow120["banrimp2"]; ?></b></td>
<td><b><?php echo $myrow120["banrpric2"]; ?></b><input type="hidden" name="ordern" value="order_8"></td>
<?php
}elseif(!empty($_POST["order_63"])) {
?>
<td><b><?php echo $myrow120["banrsize"]; ?></b></td>
<td><b><?php echo $myrow120["banrimp3"]; ?></b></td>
<td><b><?php echo $myrow120["banrpric3"]; ?></b><input type="hidden" name="ordern" value="order_9"></td>
<?php
}
?>
</tr>
...
<div class="ftal"><b>Transaction ID / Batch Number:</b></div>
<input type="text" name="trbanumber" value="" placeholder="Transaction ID / Batch Number" />
</div>
<div id="triangle1">Create New Text Ads</div>
<div class="abodyf1">
<div class="ftal">Headline: ( Minimum 25 characters )</div>
<input name="headline"  type="text" placeholder="Headline" maxlength="25" />
<div class="ftal">Describe :  ( Minimum 78 characters )</div>
<input name="describe" type="text" placeholder="Describe" maxlength="78" />
<div class="ftal">Describe :  ( Minimum 41 characters using ad two columns)</div>
<input name="descricol" type="text" placeholder="Describe" maxlength="41" />
<div class="ftal">Display URL:</div>
<input name="displayurl" type="text" placeholder="Display URL" />
<div class="ftal">Target URL:</div>
<input name="targeturl" type="text" placeholder="http://">
<input type="submit" name="newweb" value="ADD" />
</div>
</div>
</form>
</div>
...
?>
<style>
.fautable{border-collapse: collapse;border: 1px solid #ddd;width: 100%;background:<?php echo $flboxc ?>;}
.fautable th{border: 1px solid #ddd;background:<?php echo $fltc ?>;padding:10px;}
...
<td>
<div class="clearfixa">
<div class="bodyc" style="background-color:<?php echo $balanceboxc ?>;">
<?php
...
<tr>
<?php
$sqlrwb = "SELECT * FROM reward WHERE hideshow='show'";
$resultrwb = mysqli_query($mysqli, $sqlrwb);
while($myrowrwb = mysqli_fetch_array($resultrwb)){
?>
<td><a href="?currency=<?php echo $myrowrwb["curname"]; ?>"><img src="asset/img/<?php echo strtolower($myrowrwb["curname"]); ?>.png" title="<?php echo $myrowrwb["curname"]; ?>"></a></td>
<?php
}
?>
</tr>
...
<h1>Claim <?php echo $satoshi ?> satoshi (<?php echo $curname ?>) every <?php echo $claimwtime ?> minutes</h1>
<?php
$payoutwebsite = $mysqli->query("SELECT * FROM settings WHERE id = '38'")->fetch_object()->value;
if ($payoutwebsite == "Faucethub.io") {
$regwebsite = "<p class='alert-news'>Faucet moved to <a target='_blank' href='https://faucethub.io/?r=76287'>on Faucethub.io</a>. Register, link your " . $curname . " Or E-mail address and start claiming.</p>";
}elseif ($payoutwebsite == "Expresscrypto.io") {
$regwebsite = "<p class='alert-news'>Faucet moved to <a target='_blank' href='https://expresscrypto.io/signup?referral=17665'>on Expresscrypto.io</a>. Register, link your " . $curname . " Or E-mail address and start claiming.</p>";
}elseif ($payoutwebsite == "Faucetpay.io") {
$regwebsite = "<p class='alert-news'>Faucet moved to <a target='_blank' href='https://faucetpay.io/?r=76287'>on FaucetPay.io</a>. Register, link your " . $curname . " Or E-mail address and start claiming.</p>";
}elseif ($payoutwebsite == "Microwallet.co") {
$regwebsite = "<p class='alert-news'>Faucet moved to <a target='_blank' href='https://microwallet.co/?r=76287'>on Microwallet.co</a>. Register, link your " . $curname . " Or E-mail address and start claiming.</p>";
}
?>
...
<div class="clearfixa">
<div class="bodyc" style="background-color:<?php echo $startpagec ?>;">
<div id="login">
<table border="0" width="100%">
<tbody>
<tr><td width="150" valign="top">
...
$result = mysqli_query($mysqli, $sql);
$rowcou = mysqli_num_rows( $result );
if ($rowcou > "0"){
include("adsshow.php");
}
?>
<style>
#openpop{display:block;position:fixed;z-index:2;background:lightgreen;width:100%;height:100%;left:0;top:0;opacity:0.8;}
...
echo "No Ads Add in Record<br>Click This Line Remove ads page";
}
?>
</div>
</center>
...
$sql = "SELECT * from banners";
$result = mysqli_query($mysqli, $sql);
$rowcoua = mysqli_num_rows( $result );
if ($rowcoua > "0"){
include("adsshow.php");
}
?>
...
?>
<input type="text" name="address" placeholder="Enter Your Address Or E-Mail Address" <?php echo (isset($_COOKIE['address'])) ? 'value="' .$_COOKIE["address"]. '"' : ''; ?>  required>
<?php
}elseif ($payoutwebsite == "Expresscrypto.io") {
?>
...
<tr><td>
<div class="clearfixa">
<div class="bodyc" style="background-color:<?php echo $waitc ?>;">
<table border="0" width="100%">
<tbody>
<tr><td width="150" valign="top">
<?php
...
<td>
<div class="clearfixa">
<div class="bodyc" style="background-color:<?php echo $rlboxc ?>;">
<div class="member" style="background-color:<?php echo $rlmc ?>;">
<div class="cover" style="background-color:<?php echo $rlhc ?>;">
Ref link
</div>
<div class="coverbody" style="background-color:<?php echo $rlbc ?>;">
<?php
...
<td>
<div class="clearfixa">
<div class="bodyc" style="background-color:<?php echo $rpboxc ?>;">
<div class="member" style="background-color:<?php echo $rpmc ?>;">
<div class="cover" style="background-color:<?php echo $rphc ?>;">
Recent Payouts
</div>
<div class="coverbody" style="background-color:<?php echo $rpbc ?>;">
<table border="0" width="100%">
...
<td>
<?php
$payoutr = $myrowfaul["address"];
if(strpos($payoutr, "@") !== false){
$firstl = strtok($payoutr, "@");
$lastm = substr($payoutr, strpos($payoutr, "@"));
$w1 = substr($firstl, 0, 1);  // bcd
$w2 = substr($firstl, -1, 1);  // bcd
$co = strlen($firstl);
$co = $co - 2;
$my_head = str_repeat("*", $co);
$fulf = $w1.$my_head.$w2;
$rsetpayout = $fulf.$lastm;
} else{
$rsetpayout = $payoutr;
}
echo $rsetpayout;
...
<td>
<div class="clearfixa">
<div class="bodyc" style="background-color:<?php echo $biboxc ?>;">
<div class="member" style="background-color:<?php echo $bimc ?>;">
<div class="cover" style="background-color:<?php echo $bihc ?>;">
What is Bitcoin
</div>
<div class="coverbody" style="background-color:<?php echo $bibc ?>;">
...
<td>
<div class="clearfixa">
<div class="bodyc" style="background-color:<?php echo $bwboxc ?>;">
<div class="member" style="background-color:<?php echo $bwmc ?>;">
<div class="cover" style="background-color:<?php echo $bwhc ?>;">
What is Bitcoin wallet
</div>
<div class="coverbody" style="background-color:<?php echo $bwbc ?>;">
...
<td>
<div class="clearfixa">
<div class="bodyc" style="background-color:<?php echo $wfboxc ?>;">
<div class="member" style="background-color:<?php echo $wfmc ?>;">
<div class="cover" style="background-color:<?php echo $wfhc ?>;">
What is Bitcoin Faucet
</div>
<div class="coverbody" style="background-color:<?php echo $wfbc ?>;">
...
<td>
<div class="clearfixa">
<div class="bodyc" style="background-color:<?php echo $faqboxc ?>;">
<div class="member" style="background-color:<?php echo $faqmc ?>;">
<div class="cover" style="background-color:<?php echo $faqhc ?>;">
FAQ
</div>
<div class="coverbody" style="background-color:<?php echo $faqbc ?>;">
<p>
<ul>
...
<footer style="background-color:<?php echo $footc ?>;">
<table border="0" width="100%">
...
Donate<br> BTC : 1LEYrV8rbSe8xtTSex1eoanSz9KgJuLkik
</span></div>
</td></tr>
</table>
</footer>
